...
with open("/home/brett/workspace/scratch/micropython/testkey.der", mode='rb') as file: # b is important -> binary
    key = file.read()
with open("/home/brett/workspace/scratch/micropython/testcert.der", mode='rb') as file: # b is important -> binary
    cert = file.read()
